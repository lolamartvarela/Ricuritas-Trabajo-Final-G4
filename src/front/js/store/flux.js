  ...
  return {
    ...
    actions: {
      ...
      getUserRole: async () => {
        try {
          ...
          const response = await Promise.all([
            fetch(
              "https://3000-lolamartvar-ricuritastr-42c56mnz3pf.ws-us87.gitpod.io/api/get-user-role",
              {
                method: "GET",
                headers: headers,
              }
      ...
      register: (
        ...
        fetch(
          "https://3000-lolamartvar-ricuritastr-42c56mnz3pf.ws-us87.gitpod.io/admin/user/",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
      ...
      getMessage: async () => {
        try {
          ...
          const resp = await fetch(
            "https://3000-lolamartvar-ricuritastr-42c56mnz3pf.ws-us87.gitpod.io/api/hello"
          );
