...
export const Register = () => {
    ...
    return (<> {
        store.auth === true ? <Navigate to="/"/> : <form className='container w-50 text-center'
            ...
            <div className="mb-3">
                ...
                <div id="userNameHelp" className="form-text">Aquí va su nombre</div>
            </div>

            <div className="mb-3">
                <label htmlFor="exampleInputUserName" className="form-label">Apellido de usuario</label>
                <input type="text" className="form-control" id="exampleInputUserName" aria-describedby="userNameHelp"
                    value={apellido}
                    onChange={
                        (e) => setApellido(e.target.value)
                    }/>
                <div id="userNameHelp" className="form-text">Aquí va su apellido</div>
            </div>
