            ...
            <div className="jumbotron">
                ...
                <div className="d-flex mt-4 mb-4">
                    <div className="card-body">
                        ...
                        <p className="mx-4 card-text text-responsive text-lg">Una alimentación saludable es aquella que provee alimentos en forma variada y equilibrada para brindar al organismo todos los nutrientes y energía necesarios para la vida.<br/>
