    ...
    <>
      <nav className="navbar bg-body-tertiary">
        <div className="col-12 d-flex justify-content-end px-5">
          {store.auth === false ? (
            <Link to={"/login"} className="btn btn-warning me-1">
              Login
            </Link>
          ) : null}
          {store.auth === false ? (
            <Link to={"/register"} className="btn btn-warning me-1">
              Register
            </Link>
          ) : null}
          {store.auth === true ? (
            <Link to={"/dashboard"} className="btn btn-warning me-1">
              Dashboard
            </Link>
          ) : null}
          {store.auth === true ? (
          ...
          <div>
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav">
                ...
                <Link to={"/ViewComeConsciente/"} className="nav-link">
                  Come consciente
                </Link>
